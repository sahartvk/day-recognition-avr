...
_0x0:
	.DB  0x64,0x61,0x79,0x20,0x2D,0x3E,0x20,0x0
	.DB  0x6E,0x69,0x67,0x68,0x74,0x20,0x2D,0x3E
	.DB  0x20,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020060:
...
; 0000 0037 
; 0000 0038 int sen = 0;
; 0000 0039 char str[17];
; 0000 003A char temp[10];
; 0000 003B 
...
; 0000 004A // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=In
; 0000 004B DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (1<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(2)
	OUT  0x14,R30
; 0000 004C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=T
...
; 0000 0099 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 009A ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
; 0000 009B SFIOR=(0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 009C 
...
; 0000 00A8 // RS - PORTD Bit 0
; 0000 00A9 // RD - PORTD Bit 1
; 0000 00AA // EN - PORTD Bit 2
; 0000 00AB // D4 - PORTD Bit 4
; 0000 00AC // D5 - PORTD Bit 5
; 0000 00AD // D6 - PORTD Bit 6
; 0000 00AE // D7 - PORTD Bit 7
; 0000 00AF // Characters/line: 16
...
; 0000 00C0 
; 0000 00C1 
; 0000 00C2           itoa(sen, temp);
	ST   -Y,R17
	ST   -Y,R16
	MOVW R26,R28
	ADIW R26,2
	CALL _itoa
; 0000 00C3           strcat(str, temp);
	CALL SUBOPT_0x0
	MOVW R26,R28
	ADIW R26,2
	CALL _strcat
; 0000 00C4           lcd_puts(str);
	MOVW R26,R28
	ADIW R26,10
	RCALL _lcd_puts
